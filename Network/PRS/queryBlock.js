...
function queryB() {
  ...
  return new Promise(resolve => {
	...
	var custom_path = path.join(__dirname, '../../../hyperledger/fabric-samples/PRS/hfc-key-store')
	...
	Fabric_Client.newDefaultKeyValueStore({ path: store_path
		...
		return channel.queryBlock(parseInt(process.argv.slice(2)),peer);
